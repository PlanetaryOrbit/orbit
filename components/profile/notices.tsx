...
const Notices: FC<Props> = ({
  ...
  const createNotice = async () => {
    ...
    try {
      ...
      const res = await axios.post(`/api/workspace/${workspaceId}/activity/notices/record`, {
        userId: userId,
