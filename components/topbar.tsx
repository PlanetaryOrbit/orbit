...
const Topbar: NextPage = () => {
  ...
  async function googleUnlink() {
    const toastId = toast.loading("Unlinking your Google account...");
    try {
      await axios.post("/api/auth/google/unlink");
      toast.success("Google account unlinked", { id: toastId });
  ...
  return (
    <>
      <Toaster position="bottom-center" toasterId="toaster-topbar" />
                    ...
                    {login.googleUser ? (
                      <div className="flex items-center gap-3 p-4 rounded-xl border border-zinc-200 dark:border-zinc-600">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-zinc-500 dark:text-zinc-400">Google linked</p>
                        </div>
                        <button
                          type="button"
