    ...
    >
      ...
      <span
        className={clsx(
          ...
          enabled ? 'text-zinc-900 dark:text-white' : 'text-zinc-400 dark:text-zinc-500',
        )}
      >
  ...
  return (
    <div>
      ...
      <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-3">
        Shown in the sidebar, browser tab, and workspace switcher. Orbit stores a copy from when the
        workspace was created; refresh it if your Roblox group emblem changed.
      </p>
