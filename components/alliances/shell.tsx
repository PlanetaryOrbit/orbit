...
export function AlliancesPanel({
  ...
  return (
    <div
      onClick={onClick}
      className={clsx('rounded-2xl bg-white dark:bg-zinc-900/70', alliancesPanelShadow, className)}
    >
      {children}
    </div>
  );
...
export function AlliancesFormInset({
  ...
  return (
    <div className={clsx('rounded-xl bg-zinc-50/80 p-4 dark:bg-zinc-800/40', className)}>
      {children}
    </div>
  );
}
