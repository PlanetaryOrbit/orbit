...
export async function handler(req: AuthenticatedRequest, res: NextApiResponse<Data>) {
  ...
  sessionTypes.forEach((type) => {
    ...
    sessionPermissions[`Create Unscheduled ${typeCapitalized} Sessions`] =
      `sessions_${type}_unscheduled`;
    sessionPermissions[`Create Scheduled ${typeCapitalized} Sessions`] =
      `sessions_${type}_scheduled`;
