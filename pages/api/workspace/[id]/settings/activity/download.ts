...
export async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (isVercel) {
    try {
      const response = await axios.get(
        'https://raw.githubusercontent.com/PlanetaryOrbit/orbit/refs/heads/main/Orbit-activity.rbxmx',
        {
          headers: {
  ...
  res.setHeader('Content-Disposition', 'attachment; filename=Orbit-activity.rbxmx');
