...
export async function handler(
  ...
  try { await logAudit(parseInt(req.query.id as string), (req as any).auth?.userId || null, 'settings.activity.privateserver.update', 'activity.privateserver', { before: activityconfig, after: newconfig }); } catch (e) {}
