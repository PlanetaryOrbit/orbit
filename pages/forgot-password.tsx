...
const ForgotPassword: NextPage = () => {
  ...
  useEffect(() => {
    axios
      .get('/api/instance/login-background')
      .then((res) => {
      ...
      <div className="min-h-screen flex flex-col md:flex-row bg-zinc-950">
        {loginBg ? (
          ...
          <>
            ...
            />
            <div
              className="fixed inset-0 bg-gradient-to-br from-primary/30 via-zinc-950/80 to-zinc-950"
              aria-hidden
            />
          </>
        )}
            ...
            <div className="rounded-2xl bg-white/95 dark:bg-zinc-800/95 backdrop-blur-xl border border-zinc-200/60 dark:border-zinc-700/50 shadow-xl shadow-zinc-900/5 dark:shadow-black/20 p-8">
                ...
                <>
                  <div className="flex items-start gap-5 mb-8">
                    ...
                    <div className="min-w-0 flex-1 pt-0.5">
                      <h2 className="text-xl font-semibold text-zinc-900 dark:text-white tracking-tight">
                        Are you really{' '}
                        <span className="text-primary">{resetDisplayName || 'this user'}</span>?
                      </h2>
                      <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
                        Confirm this is your Roblox account. Next, we’ll ask you to add a
                        verification code to your profile.
                      </p>
                    </div>
                  </div>
              ...
              {selectedSlide === 2 && (
                <>
                  ...
                  <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400 mb-6">
                    Paste the code below into your Roblox profile blurb to prove ownership, then
                    click Verify.
                  </p>
                  ...
                  <FormProvider {...passwordForm}>
                    <form className="space-y-4" onSubmit={passwordForm.handleSubmit(finishReset)}>
                        ...
                        <Input
                          ...
                          {...passwordForm.register('password', {
                            ...
                            validate: (value) => {
                              ...
                              return score >= 3 || 'Your password must be at least Strong';
                            },
                          })}
                          label="New password"
                        />
                      ...
                      <p className="mt-4 text-xs text-zinc-500 dark:text-zinc-400 text-center">
                        Don’t share your password. Don’t use the same password as your Roblox
                        account.
                      </p>
                    </form>
                  </FormProvider>
